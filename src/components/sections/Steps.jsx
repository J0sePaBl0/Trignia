...
export default function Steps() {
  return (
    <section  className="w-full mt-20 "style={{
        ...
        className="text-3xl md:text-4xl title-font px-4">NO TE QUEDES ATRÁS. EL FUTURO CLÍNICO YA COMENZÓ.</motion.h1>
        <style>{`
          @keyframes bgMove {
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left grid-cols-1">
            ...
            transition={{ duration: 0.8 }}>
              <div className="text-4xl font-extrabold subtitles2-styles flex">1
            ...
            <motion.div className="pl-8 text-right flex-col justify-end"
            initial = {{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div className="pr-8 text-left pt-15 md:pt-12"
            initial = {{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div className="pl-8 text-right pt-15 md:pt-12"
            initial = {{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
